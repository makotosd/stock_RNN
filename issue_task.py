...
def main():
    ...
    while(True):
        ...
        if not dequeued_task.is_empty:
            ...
            sleep(10)
            '''
            train.train(dequeued_task.cc, dequeued_task.target_feature, dequeued_task.rnn, 
                        dequeued_task.num_of_neuron, dequeued_task.batch_size, dequeued_task.num_train)
            '''
